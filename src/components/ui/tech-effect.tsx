...
const availableIcons = [
  { component: Cpu, color: "hsl(var(--primary))" }, 
  { component: CircuitBoard, color: "hsl(var(--accent))" },
  { component: Code2, color: "hsl(var(--secondary))" }
];

const TechEffect: React.FC<{ onAnimationEnd: () => void; animationKey: number }> = ({ onAnimationEnd, animationKey }) => {
